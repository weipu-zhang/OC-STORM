...
from feature_extractor.cutie.build_feature_extractor import VectorPlusVisualExtractor
from configs.hollow_knight_object_info import num_object_mapping_factory


# Buffer
from utils.replay_buffer import ReplayBufferVectorPlusVisual

# Agent - Visual input with object vectors generated by Cutie (OC-STORM)
from agents.vector_visual.agent import Agent
...
def build(
    ...
    Params, LocalAbstractHKEnv, IndependentActionSpace, VectorPlusVisualExtractor, ReplayBufferVectorPlusVisual, Agent
]:
    params = Params()
    ...
    feature_extractor = VectorPlusVisualExtractor(
    ...
    # Buffer
    replay_buffer = ReplayBufferVectorPlusVisual(
        state_shape=(params.num_objects, params.object_feature_dim),
        obs_shape=(3, 64, 64),
