...
from envs.hollow_knight.build_env import build_hollow_knight_env_ban_spell
...
def build(
    env_name, seed
) -> Tuple[Params, LocalAbstractHKEnv, IndependentActionSpace, ResizeObservation, VisualReplayBuffer, Agent]:
    params = Params()
    ...
    env, action_space = build_hollow_knight_env_ban_spell(boss_name, obs_size=(height, width), target_fps=9)
