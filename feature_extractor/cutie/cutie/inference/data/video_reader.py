...
class VideoReader(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        self.im_resize = transforms.Resize(size, interpolation=InterpolationMode.BILINEAR, antialias=True)
        self.mask_resize = transforms.Resize(size, interpolation=InterpolationMode.NEAREST, antialias=True)
        self.size = size
