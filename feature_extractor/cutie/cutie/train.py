...
from feature_extractor.cutie.cutie.model.trainer import Trainer
from feature_extractor.cutie.cutie.dataset.setup_training_data import (
...
def train(cfg: DictConfig):
    ...
    def occupy(temp):
        ...
        if free > 0:
            ...
            temp.extend([torch.zeros((2**28), dtype=torch.uint8, device="cuda") for _ in range(free)])
